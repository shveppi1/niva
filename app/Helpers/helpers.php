...
if (!function_exists('add_array_to_json')) {
    function add_array_to_json($addArrValue, $oldJson)
    {
        $arJson = json_decode($oldJson, true);

        return array_merge($addArrValue, $arJson);
    }
}
